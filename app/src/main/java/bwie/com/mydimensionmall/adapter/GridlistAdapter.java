...
class GridlistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<RecyclerBoods.ResultBean.PzshBean.CommodityListBeanX> list;

    public GridlistAdapter(Context context, List<RecyclerBoods.ResultBean.PzshBean.CommodityListBeanX> listpzsh) {
        super();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = View.inflate(context, R.layout.recycler_layout_pzsh, null);
    ...
    private class HolderView extends RecyclerView.ViewHolder {
        ...
        public HolderView(View view) {
            super(view);
            image_grid = itemView.findViewById(R.id.image_grid3);
            text_grid_name = itemView.findViewById(R.id.text_grid_name3);
            text_grid_pras = itemView.findViewById(R.id.text_grid_pras3);
        }
    }
}
