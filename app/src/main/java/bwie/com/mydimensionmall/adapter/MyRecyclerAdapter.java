...
public class MyRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<RecyclerBoods.ResultBean.RxxpBean.CommodityListBean> list;

    public MyRecyclerAdapter(Context context, List<RecyclerBoods.ResultBean.RxxpBean.CommodityListBean> listrxxp) {
        super();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = View.inflate(context, R.layout.layout_grid_adapter, null);
    ...
    private class HolderView extends RecyclerView.ViewHolder {
        ...
        public HolderView(@NonNull View itemView) {
            ...
            text_grid_name = itemView.findViewById(R.id.text_grid_name);
            text_grid_pras = itemView.findViewById(R.id.text_grid_pras);
